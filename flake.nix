        ...
        let
          ...
          pkgs = import inputs.nixpkgs {
            ...
            overlays = [
              (_: prev: {
                haskellPackages =
                  prev.haskell.packages."ghc${ghcVersion}".override {
                    overrides = self: super: rec {
                      copilot-c99 =
                        prev.haskell.lib.compose.dontCheck super.copilot-c99;
                    };
                  };
              })
            ];
        ...
        in {
          ...
          devShells = {
            default = pkgs.haskellPackages.shellFor {
              ...
              shellHook = ''
                export PS1="\n\[\033[1;32m\][nix-shell:\W \[\033[1;31m\]Haskell\[\033[1;32m\]]\$\[\033[0m\] "
                echo -e "\n\033[1;31m ♣ ♠ Welcome to Haskell! ♥ ♦ \033[0m\n"
